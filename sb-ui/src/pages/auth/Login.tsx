            ...
            <div className="flex flex-col gap-7 max-w-105 w-full">
                ...
                <form className="bg-white py-8 px-7 rounded-2xl shadow-sm flex flex-col gap-5 w-full">
                    ...
                    <div className="flex flex-col gap-3">
                        <button className="bg-[#3a5740] text-white font-medium px-5 py-2.5 text-sm rounded-lg cursor-pointer hover:brightness-90 active:scale-[0.99]">Đăng nhập</button>
